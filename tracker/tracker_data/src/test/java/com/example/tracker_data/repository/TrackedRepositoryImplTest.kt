...
class TrackedRepositoryImplTest {

    private lateinit var repository: TrackedRepositoryImpl
    ...
    fun setUp() {
        ...
        api = Retrofit.Builder()
            ...
            .build()
            .create()
        repository = TrackedRepositoryImpl(
    ...
    fun `Search food, valid response, returns results`() = runBlocking {
        ...
        val result = repository.searchFood("banan", 1, 40)
